#!/usr/bin/env python3
"""
Main training script for the hybrid model (SSD320 + MobileNet)
"""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Train Hybrid Model (SSD320 + MobileNet)')
...
def setup_model(args, device):
    ...
    if args.checkpoint_path and os.path.exists(args.checkpoint_path):
        ...
        model = load_trained_model(model, args.checkpoint_path, device)
